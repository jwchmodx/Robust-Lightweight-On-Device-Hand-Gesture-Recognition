...
BACKGROUND_LABEL = "Doing other things"

LABEL_MAP = {
    label: i for i, label in enumerate(SELECTED_LABELS)
}
...
def main() -> None:
    ...
    parser.add_argument(
        "--train-processed",
        default="data/processed_baseline_static_conf05/train",
        help="Tracking 설정으로 생성한 train 개별 npy 폴더",
    )

    parser.add_argument(
        "--val-processed",
        default="data/processed_baseline_static_conf05/validation",
